...
export const fetchData = locationData => (dispatch) => {
  ...
  const endPoint = `https://developers.zomato.com/api/v2.1/geocode?lat=${lat}&lon=${lng}&count=20&radius=5000&sort=rating&order=asc`;

  return axios.get(endPoint, {
    headers: {
      "user-key": "bb5e0e240f8a6998a155cc663e6d9138"
    }
  })
  .then((response) => {
